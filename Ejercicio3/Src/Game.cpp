...
void Game::DrawGame()
{
    ...
    // Dibujar obstáculos
    sf::RectangleShape obstacle1(sf::Vector2f(10, 10));
    obstacle1.setFillColor(sf::Color::Blue);
    obstacle1.setOrigin(5, 5);
    obstacle1.setPosition(30, 50);
    wnd->draw(obstacle1);

    sf::RectangleShape obstacle2(sf::Vector2f(15, 5));
    obstacle2.setFillColor(sf::Color::Green);
    obstacle2.setOrigin(7.5, 2.5);
    obstacle2.setPosition(70, 30);
    wnd->draw(obstacle2);
...
void Game::InitPhysics()
{
    ...
    b2Body* obstacle1 = Box2DHelper::CreateRectangularStaticBody(phyWorld, 10, 10);
    obstacle1->SetTransform(b2Vec2(30, 50), 0.0f);

    b2Body* obstacle2 = Box2DHelper::CreateRectangularStaticBody(phyWorld, 15, 5);
    obstacle2->SetTransform(b2Vec2(70, 30), 0.0f);
